...
\begin{enumerate}
    \item FISTA 可被用于恢复各种信号和图像，这暗示基于优化的神经网络也有可能具备类似的恢复能力。例如\cite{zhang2018ista}提出了一种基于 ISTA 的神经网络架构，称为 ISTA-Net，用于感知压缩等任务的端到端学习，其每一层的网络操作本质是对一次 ISTA 迭代的“网络化映射”。类似地，FISTA 也可以被“网络化”，形成 “FISTA-Net”，从而提升恢复性能。
    \item \cite{dhurandhar2018explanations} 以 FISTA 为核心算法，探究模型以某种特征的缺失作为分类依据的可解释性，
    \item 深度学习中常使用到的稀疏自编码器（sparse autoencoder，SAE）等价于求解带 $l_1$ 正则化的优化问题，而 FISTA 可作为高效的求解器嵌入到 SAE 的训练过程中，从而提升训练效率和模型性能。
\end{enumerate}
